...
class RMSNorm(torch.nn.Module):
    ...
    # Reference: Code borrowed from the official Llama implementation
    # https://github.com/facebookresearch/llama/blob/main/llama/model.py    
    def _norm(self, x):
        """
...
class Attention(nn.Module):
    ...
    # Reference: Got the idea from forward() function in Attention class from official Llama implementation
    # https://github.com/facebookresearch/llama/blob/main/llama/model.py    
...
class LlamaLayer(nn.Module):
    ...
    # Reference: Got the idea from forward() function in TransformerBlock class from official Llama implementation
    # https://github.com/facebookresearch/llama/blob/main/llama/model.py
    def forward(self, x):
        '''
...
class Llama(LlamaPreTrainedModel):
    ...
    # Reference: Code borrowed (with slight adjustment )from llama2.c by Andrej Karpathy https://github.com/karpathy/llama2.c/blob/master/model.py
